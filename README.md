...
This repository is implementation of paper **VAN: Versatile Affinity Network for End-to-end Online Multi-Object Tracking** (ACCV2020)

This repository is based on Tracktor (**Tracking without bells and whistles**).
